...
#define TABLE_CELL_HEIGHT 97.0f
...
//    cell.textLabel.text = chatData.username;
//    cell.detailTextLabel.text = chatData.message;
//    cell.imageView.image = [UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:chatData.avatar_url]]];
